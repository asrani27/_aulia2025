            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <select name="jenis_laporan" id="jenis_laporan"
                        ...
                        <option value="tim_audit" @if(old('jenis_laporan')=='tim_audit' ) selected @endif>Kegiatan Audit
                        </option>
                        <option value="jadwal_audit" @if(old('jenis_laporan')=='jadwal_audit' ) selected @endif>Jadwal
                            Audit</option>
                        <option value="pemeriksaan" @if(old('jenis_laporan')=='pemeriksaan' ) selected @endif>
                            Pemeriksaan</option>
                        <option value="tindak_lanjut" @if(old('jenis_laporan')=='tindak_lanjut' ) selected @endif>Tindak
                            Lanjut</option>
                    </select>
                    @error('jenis_laporan')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
