...
@section('title', 'Tambah Tim Audit')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="glass-effect rounded-2xl shadow-xl p-6 mb-6 border border-white/20">
        <div class="flex items-center">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-800 mb-2">Tambah Tim Audit</h1>
                <p class="text-gray-600">Form tambah tim audit baru</p>
            </div>
        </div>
    </div>
    ...
    <div class="glass-effect rounded-2xl shadow-xl p-6 border border-white/20">
        <form action="{{ route('tim_audit.store') }}" method="POST">
            @csrf
                ...
                <div class="space-y-2 max-h-60 overflow-y-auto border border-gray-300 rounded-lg p-4">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" 
                               ...
                               {{ old('anggota') && in_array($pegawai->id, old('anggota')) ? 'checked' : '' }}>
